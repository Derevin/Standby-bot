...
async def coinflip_resp(bot, message: nextcord.Message):
...
async def mario_resp(bot, message: nextcord.Message):
...
async def uhoh_resp(bot, message: nextcord.Message):
...
async def spooky_resp(bot, message: nextcord.Message):
...
async def tuesday_resp(bot, message: nextcord.Message):
...
async def yeboi_resp(bot, message: nextcord.Message):
...
async def cough_bless_resp(bot, message: nextcord.Message):
...
async def egeis_resp(bot, message: nextcord.Message):
...
async def fme_resp(bot, message: nextcord.Message):
